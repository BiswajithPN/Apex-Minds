      ...
      <div className="relative bg-gradient-to-br from-[#022a22] via-[#033d32] to-[#065f46] text-white overflow-hidden
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <img src="/Hirehub-logo.png" alt="HireHub" className="w-11 h-11 rounded-xl object-contain mix-blend-multiply" />
      ...
      <div className="flex-1 flex items-center justify-center relative
        ...
        <div className="w-full max-w-[380px] space-y-8 relative z-10">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-2">Sign in to continue to your dashboard</p>
          </div>
