      ...
      >
        ...
        <div className="w-full max-w-full sm:max-w-[380px] space-y-8 relative z-10">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 font-medium mt-2">Select your role and sign up with Google</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { value: 'jobseeker', label: 'Student', sub: 'Find jobs with AI scores' },
                ...
                <div className="flex items-center gap-2.5 mb-1.5">
                  <div
                    className={`p-1.5 rounded-lg ${
                      role === r.value ? 'bg-emerald-600 text-white' : 'bg-slate-100 text-slate-500'
                    }`}
                  >
