...
export default function CompanyProfile() {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      setSuccess(true);
      if (isOnboarding) {
        setTimeout(() => navigate('/employer/jobs?onboarding=1', { replace: true }), 1200);
      } else {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <input
                {...register('companyName', {
                  ...
                  validate: (v) => (v && v.trim() ? true : 'Company name cannot be empty')
                })}
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              {errors.industry && <p className="text-xs text-danger-500 mt-1">{errors.industry.message}</p>}
            </div>
            <div>
              ...
              <div className="relative">
                ...
                />
                {errors.website && <p className="text-xs text-danger-500 mt-1">{errors.website.message}</p>}
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end pt-4 border-t border-slate-100">
            <Button type="submit" loading={isSubmitting} className="shadow-md shadow-accent-500/20">
              ...
              {isOnboarding ? 'Save & Continue' : 'Save & Sync Profile'}
            </Button>
          </div>
        </form>
      </Card>
